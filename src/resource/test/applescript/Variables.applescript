...
--Credits
    ...
    --set songWriter to
    --set songProducer to
    --set songAdditionalDrums to
    --set songAdditionalKeyboards to
    --set songBackgroundVocals to
    --set songPublisher to
    --set songCopyrights to
    --set songWebsite to
    --set songCreditsSample to
    --set songCreditsRemake to
    --set songCreditsFilm to
--
--Copyrights
    (*
